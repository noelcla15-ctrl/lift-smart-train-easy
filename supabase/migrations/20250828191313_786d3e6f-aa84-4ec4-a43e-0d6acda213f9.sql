...
-- Now insert comprehensive exercise database with correct movement patterns
...
('Incline Chest Press', 'Strength', ARRAY['chest', 'triceps', 'shoulders'], 'dumbbell', 'push_vertical', 'intermediate', 'medium', true, 'Incline bench press targeting upper chest'),
...
('Crunches', 'Core', ARRAY['core'], 'bodyweight', 'isolation', 'beginner', 'easy', false, 'Abdominal crunching movement'),
('Russian Twists', 'Core', ARRAY['core', 'obliques'], 'bodyweight', 'rotation', 'beginner', 'easy', false, 'Seated torso rotation movement'),
('Dead Bug', 'Core', ARRAY['core'], 'bodyweight', 'isolation', 'beginner', 'easy', false, 'Lying opposite arm/leg extension'),
('Bicycle Crunches', 'Core', ARRAY['core', 'obliques'], 'bodyweight', 'rotation', 'intermediate', 'medium', false, 'Alternating knee to elbow crunches'),
('Leg Raises', 'Core', ARRAY['core', 'hip_flexors'], 'bodyweight', 'isolation', 'intermediate', 'medium', false, 'Lying leg lifting movement'),

-- Cardio/Conditioning (using isolation pattern)
('Jumping Jacks', 'Cardio', ARRAY['full_body'], 'bodyweight', 'isolation', 'beginner', 'easy', false, 'Jump feet apart while raising arms overhead'),
('High Knees', 'Cardio', ARRAY['legs', 'core'], 'bodyweight', 'isolation', 'beginner', 'easy', false, 'Running in place with high knee lifts'),
('Butt Kickers', 'Cardio', ARRAY['hamstrings', 'glutes'], 'bodyweight', 'isolation', 'beginner', 'easy', false, 'Running in place kicking heels to glutes'),
('Bear Crawl', 'Strength', ARRAY['shoulders', 'core', 'legs'], 'bodyweight', 'carry', 'intermediate', 'medium', true, 'Crawl forward on hands and feet'),
