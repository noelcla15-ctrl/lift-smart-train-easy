-- First, update existing exercises with invalid movement patterns
UPDATE exercises SET movement_pattern = 'push' WHERE movement_pattern IS NULL AND category = 'push';
UPDATE exercises SET movement_pattern = 'pull' WHERE movement_pattern IS NULL AND category = 'pull';
UPDATE exercises SET movement_pattern = 'squat' WHERE movement_pattern IS NULL AND category = 'legs' AND name ILIKE '%squat%';
UPDATE exercises SET movement_pattern = 'hinge' WHERE movement_pattern IS NULL AND category = 'legs' AND (name ILIKE '%deadlift%' OR name ILIKE '%hinge%');
UPDATE exercises SET movement_pattern = 'lunge' WHERE movement_pattern IS NULL AND category = 'legs' AND name ILIKE '%lunge%';
UPDATE exercises SET movement_pattern = 'horizontal_push' WHERE movement_pattern IS NULL AND (name ILIKE '%bench%' OR name ILIKE '%chest%' OR name ILIKE '%push%');
UPDATE exercises SET movement_pattern = 'vertical_push' WHERE movement_pattern IS NULL AND (name ILIKE '%shoulder%' OR name ILIKE '%overhead%' OR name ILIKE '%press%');
UPDATE exercises SET movement_pattern = 'horizontal_pull' WHERE movement_pattern IS NULL AND (name ILIKE '%row%' OR name ILIKE '%pull%');
UPDATE exercises SET movement_pattern = 'vertical_pull' WHERE movement_pattern IS NULL AND (name ILIKE '%pullup%' OR name ILIKE '%pulldown%' OR name ILIKE '%chin%');
UPDATE exercises SET movement_pattern = 'flexion' WHERE movement_pattern IS NULL AND (name ILIKE '%curl%' OR name ILIKE '%crunch%');
UPDATE exercises SET movement_pattern = 'extension' WHERE movement_pattern IS NULL AND (name ILIKE '%extension%' OR name ILIKE '%raise%');
UPDATE exercises SET movement_pattern = 'isometric' WHERE movement_pattern IS NULL AND name ILIKE '%plank%';
UPDATE exercises SET movement_pattern = 'carry' WHERE movement_pattern IS NULL AND name ILIKE '%carry%';
-- Set default for any remaining NULL values
UPDATE exercises SET movement_pattern = 'push' WHERE movement_pattern IS NULL;

-- Now add the constraint that includes warm-up and cool-down movement patterns
